<div class='form-group {{$header_group_class}} {{ ($errors->first($name))?"has-error":"" }}' id='form-group-{{$name}}' style="{{@$form['style']}}">
    ...
    <div class="{{$col_width?:'col-sm-10'}}">
        ...
        <div class="col-md-8" style='padding: 0px 0px;margin: 4px 0px;'>
        ...
        <div class="col-sm-4" style='padding: 0px 0px;margin: 4px 0px;'>
            &nbsp;&nbsp;
            <button class="btn btn-sm btn-success custom-media-browse-media">Browse Media</button>
        </div>
